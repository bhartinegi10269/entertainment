...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
      ...
      <img src="/entertainment-logo.png" alt="logo" className='w-52' />
        ...
        <div className='py-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                ...
                <div className='flex-1 text-center md:text-left'>
                    <h2 className='text-4xl md:text-5xl font-extrabole mb-4'>Enjoy on your TV</h2>
            ...
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                ...
                <div className='flex-1'>
                    <div className='relative'>
                        <img src="/stranger-things-lg.png" alt="Stranger Thighs img" 
                        className='mt-4'
                        />
                ...
                <div className='flex-1 md:text-left text-center'>
                    <h2 className='text-4xl md:text-dxl font-extrabold mb-4 text-balance'>
        ...
        <div className='py-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                {/* left side */}
                <div className='flex-1 text-center md:text-left'>
                    <h2 className='text-4xl md:text-5xl font-extrabole mb-4'>Watch Everywhere</h2>
                    <p className='text-lg md:text-xl'>
